  ...
  var CASES = [
    {
      ...
      options: [
        { id: 'c01-effort', text: '자발적으로 받았어도 일해서 번 돈이 아니면 권리가 없다.' },
...

    {
      ...
      wrongLine: '기부 버튼이 도둑질 기록까지 지워 주진 않아.',
...

    {
      ...
      question: 'What would Nozick say?',
      options: [
        { id: 'c04-hands-off', text: '사기였어도 직접 결제했으니 국가는 개입하면 안 된다.' },
        { id: 'c04-fraud',     text: '사기이므로 사람들을 보호하는 국가 개입은 정당하다.' }
      ],
      answerId: 'c04-fraud',
      reason: '최소 국가도 사기로부터 사람들을 보호한다.',
      wrongLine: '‘정품이라고 했다’ — 이 한 줄이 이 사건 전부야.',
...

    {
      ...
      options: [
        ...
        { id: 'c06-reverse', text: '자발적이어도 가난한 쪽에서 부자 쪽으로 갔으니 취소해야 한다.' }
      ],
      answerId: 'c06-gift',
      reason: '받는 사람이 부자라는 이유만으로 자발적 증여가 부당해지지는 않는다.',
      wrongLine: '방향이 마음에 안 든다고 취소되면, 취소 안 될 선물이 없지.',
...

    {
      ...
      wrongLine: '자발적으로 준 건 맞아. 그런데 그 돈은 원래 누구 거였지?',
...

    {
      ...
      options: [
        ...
        { id: 'c08-majority', text: '정당한 재산이어도 압도적인 다수가 찬성했다면 가져갈 수 있다.' }
      ],
...

    {
      ...
      question: 'What would Nozick say?',
      options: [
        { id: 'c09-overpriced', text: '속임수가 없었어도 원가보다 너무 비싸면 부당한 거래다.' },
...

    {
      ...
      options: [
        ...
        { id: 'c10-antiequal', text: '자발적이어도 똑같이 나누는 것은 노직이 반대하므로 부당하다.' }
      ],
